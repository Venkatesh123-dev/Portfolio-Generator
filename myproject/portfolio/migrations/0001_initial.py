    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project1_name', models.CharField(blank=True, default='', max_length=500)),
                ('project1_url', models.CharField(blank=True, default='', max_length=500)),
                ('project1_description', models.CharField(blank=True, default='', max_length=300)),
